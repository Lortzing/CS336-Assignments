...
if __name__ == "__main__":
    ...
    print(list(pre_tokenization_with_text("hello<|endoftext|>你好", ["<|endoftext|>"]).items())[0])
    print(type(list(pre_tokenization_with_text("hello<|endoftext|>你好", ["<|endoftext|>"]).items())[0][0][0]))
