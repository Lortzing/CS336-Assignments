...
def get_chunk(start: int, end: int, input_path: str | os.PathLike, special_tokens: List[str]) -> Counter[tuple[bytes]]:
    chunk = ""
...
def pre_tokenization_with_text(start: int, end: int, input_path: str | os.PathLike, special_tokens: List[str]) -> Counter[tuple[bytes]]:
    counter = Counter()
...
if __name__ == "__main__":
    ...
    pre_tokenization(0, len(chunk), chunk, special_tokens)
    pass
