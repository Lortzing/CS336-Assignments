...
def train_bpe(
    ...
    for i in range(totel_loop):
        ...
        for word in pairs_words_map.pop(pair_bytes, []):
            ...
            print(word_new_tuple, words_pairs_map[word_new_tuple])
            
            for pair_bytes in words_pairs_map[word_new_tuple]:
                pairs_words_map[pair_bytes].remove(word)
                pairs_words_map[pair_bytes].append(word_new_tuple)
