...
def train_bpe(
    ...
    for i in range(totel_loop):
        ...
        for word in pairs_words_map.pop(pair_bytes, []):
            ...
            words_pairs_map[word_new] = words_pairs_map.pop(word)
            print(pairs_words_map)
            for pair in words_pairs_map[word_new]:
                pairs_words_map[pair].remove(word)
                pairs_words_map[pair].append(word_new)
            
            for new_pair in new_pairs:
                words_pairs_map[word_new].append(new_pair)
