...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    net = MultiHeadSelfAttentionWithRoPE.from_theta(d_model, num_heads, theta, max_seq_len)
    net.load_state_dict({
        "q_proj.weight": q_proj_weight,
        "k_proj.weight": k_proj_weight,
        "v_proj.weight": v_proj_weight,
    ...
    return net(in_features, token_positions)
...
def run_transformer_block(
    ...
    """
    net = TransformerBlock.from_theta(d_model, num_heads, d_ff, theta, max_seq_len)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return cos_learning_rate_schedule(it, warmup_iters, cosine_cycle_iters, max_learning_rate, min_learning_rate)
